...
def build_cli_parser():
    parser = optparse.OptionParser(usage="%prog [options]", description="Enumerate admin by alerts resolved")
...
def main(argv):
    ...
    admins = cb.detect_adminsbyalertsresolved(opts.count, opts.sort)
