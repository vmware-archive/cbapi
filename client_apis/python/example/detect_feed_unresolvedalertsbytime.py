...
def build_cli_parser():
    parser = optparse.OptionParser(usage="%prog [options]", description="Enumerate unresolved alerts by time")
...
def main(argv):
    ...
    unresolved_alerts = cb.detect_feed_unresolvedalertsbytime(opts.feed_name, opts.count, opts.sort)
