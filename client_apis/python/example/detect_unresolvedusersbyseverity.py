...
def build_cli_parser():
    parser = optparse.OptionParser(usage="%prog [options]", description="Enumerate unresolved users by severity")
...
def main(argv):
    ...
    unresolved_users = cb.detect_unresolvedusersbyseverity(opts.count, opts.sort)
